...
async function connectToWA() {
  ...
  danuwa.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log('✅ DULARA-MD V1 connected to WhatsApp');

      const up = `DULARA-MD V1 connected ✅\n\nPREFIX: ${prefix}`;
      await danuwa.sendMessage(ownerNumber[0] + "@s.whatsapp.net", {
        image: { url: `https://github.com/dularahasith232-cmd/DULARA-V1/blob/main/images/1789529121813.jpg` },
        caption: up
      });
...
app.get("/", (req, res) => {
  res.send("Hey, DULARA-MD V1 started✅");
});
